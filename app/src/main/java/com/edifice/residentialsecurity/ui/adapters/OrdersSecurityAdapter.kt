...
import com.edifice.residentialsecurity.ui.securityGuard.SecurityOrderDetailActivity


class OrdersSecurityAdapter(val context: Activity, private val orders: ArrayList<Order>) :
    RecyclerView.Adapter<OrdersSecurityAdapter.OrdersViewHolder>() {
    ...
    private fun goToOrderDetail(order: Order) {
        val i = Intent(context, SecurityOrderDetailActivity::class.java)
